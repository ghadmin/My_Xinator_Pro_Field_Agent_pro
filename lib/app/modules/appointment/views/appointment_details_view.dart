          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  crossAxisAlignment:
                      CrossAxisAlignment.start, // allows vertical growth
                  children: [
                    // 1st Item (Address)
                    Expanded(
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: GestureDetector(
                              onTap: () async {
                                await openMapWithRoute(controller.address);
                              },
                              child: Text(
                                controller.address,
                                style: theme.textTheme.bodyLarge?.copyWith(
                    ...
                    SizedBox(width: 10), // spacing between the two blocks

                    // 2nd Item (Mobile Number)
                    Expanded(
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Expanded(
                            child: InkWell(
                              onTap: controller.mobileNumber.isEmpty
                                  ? null
                                  : () async {
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: InkWell(
                        onTap: controller.phoneNumber.isEmpty
                            ? null
                            : () async {
                                await UrlLauncher.phoneCall(
                                    controller.phoneNumber);
                              ...
                              Padding(
                                ...
                                child: GridView.builder(
                                  ...
                                  gridDelegate:
                                    ...
                                    childAspectRatio: 4, // height of each item
                                    crossAxisSpacing: 10,
                                    mainAxisSpacing: 10,
                                  ),
                                      ...
                                      children: [
                                        GestureDetector(
                                          onTap: () {
                                            ...
                                            // controller.resources[index] = item;
                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton2<int>(
                                    ...
                                    style: theme.textTheme.bodyMedium,
                                    items: controller
                                        .settingController.appointmentsStatus
                                        .map((e) {
                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton2<int>(
                                    ...
                                    value: controller.selectedTicketStatusValue
                                                .value ==
                                            0
                                        ? null
                                        : controller
                                    ...
                                    style: theme.textTheme.bodyMedium,
                                    items: controller.settingController.tickets
                                        .map((e) {
                                      return DropdownMenuItem<int>(
                                        value: e.statusId,
                                        child: Text(
                                    ...
                                    onChanged: (int? newValue) async {
                                      ...
                                      await controller.updateAppointment();
                                      controller.selectedTicketStatusValue
                                          .value = newValue!;
                                    },
                                  ),
                                ),
                              ...
                              return GestureDetector(
                                onTap: () async {
                                  ...
                                  controller.invoiceController.due =
                                      proposal.due ?? "";
                                  controller
                                          .invoiceController.showingDate.value =
                                      dateTimeConverter(
                                  ...
                                  if (proposal.discountOption == "1") {
                                    controller.invoiceController
                                        ...
                                        (((double.parse(proposal.discount
                                                            ?.toString() ??
                                                        "0.00")) *
                                                    100) /
