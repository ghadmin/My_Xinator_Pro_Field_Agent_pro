                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              onChanged: (
                                                                                ...
                                                                                controller.selectedItemList[index].price = double.tryParse(value) ?? 0.00;
                            ...
                            child: SecondaryButtonWithIcon(
                              ...
                              onPressed: () {
                                ...
                                controller.createInvoiceEmailBccFocusnode.value
                                    .unfocus();
                                controller
                                    .createInvoiceEmailSubjectFocusnode.value
                                    .unfocus();
                                      ...
                                      return SplashContainer(
                                        ...
                                        onPressed: () {
                                          ...
                                          controller
                                              ...
                                              .unfocus();
                                          controller
                                              .createInvoiceNotesFocusnode.value
                                              .unfocus();
                                          controller
                                              .createInvoiceSearchFocusnode
                                              .value
                                          ...
                                          showMenu(
                                            ...
                                            items:
                                                controller.discountOptions.map((
                                              e,
                                            ) {
                                ...
                                builder: (context) {
                                  return SplashContainer(
                                    ...
                                    onPressed: () {
                                      FocusScope.of(context).unfocus();
                                      controller
                                          .createInvoiceDiscountFocusnode.value
                                          .unfocus();
                                      controller
                                          .createInvoiceNotesFocusnode.value
                                          .unfocus();
                                      controller
                                          .createInvoiceSearchFocusnode.value
                                          .unfocus();
                                      controller
                                          .createInvoiceEmailToFocusnode.value
                                          .unfocus();
                                      controller
                                          .createInvoiceEmailBccFocusnode.value
                                          .unfocus();
                                      controller
                                          .createInvoiceEmailSubjectFocusnode
                                          .value
                                          .unfocus();
                                      controller
                                          .createInvoiceEmailBodyFocusnode.value
                                          .unfocus();
                                      RenderBox renderBox = context
                                          .findRenderObject() as RenderBox;
